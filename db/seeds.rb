...
#   Mayor.create(name: 'Emanuel', city: cities.first)
   ...
   Achievement.create(achievement_name:"Spell your name", points:1000)
   Achievement.create(achievement_name:"Spell your mothers name", points:1500)
   Achievement.create(achievement_name:"Spell dog", points:2000)
   Achievement.create(achievement_name:"Spell cat", points:2500)
   Achievement.create(achievement_name:"Prove that god exits", points:10)
